...
function SidebarInset({ className, ...props }: React.ComponentProps<"main">) {
  return (
    <main
      ...
      className={cn(
        // min-w-0: without it, this flex item's default min-width:auto lets
        // a wide descendant (e.g. a table with nowrap cells) force the whole
        // sidebar layout wider than the viewport instead of scrolling
        // internally within its own overflow-x-auto container.
